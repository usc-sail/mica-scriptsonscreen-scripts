...
cache_dir = os.path.join(os.getenv("DATA_DIR"), "mica-movie-scripts/scriptsonscreen/cache")
...
flags.DEFINE_bool("update", default=False, help="Check for new script updates on scripts-on-screen website "
...
def scrape_scripts_on_screen(_):
    ...
    movie_scripts_dir = FLAGS.scripts
